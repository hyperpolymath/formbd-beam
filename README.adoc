...
BEAM (Erlang/Gleam/Elixir) bindings for https://github.com/hyperpolymath/formdb[FormDB] - the narrative-first database.
...
| `version()` | Get FormDB version as `#(Int, Int, Int)`
...
* https://github.com/hyperpolymath/formdb[FormDB] - The database engine
* https://github.com/hyperpolymath/formbase[FormBase] - Airtable alternative built on FormDB
