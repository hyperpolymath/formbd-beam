...
// FormDB NIF - Erlang/BEAM Native Implemented Functions
//
// Bridges FormDB's Zig C ABI to the Erlang runtime via NIFs.
...
// FormDB C ABI imports (linked at build time)
...
// FormDB types (must match types.zig)
...
pub export const formdb_nif_init = erl_nif.ErlNifEntry{
    .major = erl_nif.ERL_NIF_MAJOR_VERSION,
    .minor = erl_nif.ERL_NIF_MINOR_VERSION,
    .name = "Elixir.FormDB.NIF",
